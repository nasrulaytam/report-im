...
@section('main-content')
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800">{{ __('Add Report') }}</h1>
        ...
        <div class="col-lg-10 order-lg-1">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('addreport') }}" autocomplete="off">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="name" class="form-control" name="name" placeholder="Laporan Bulan Maret" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="regulator" class="form-control" name="regulator" placeholder="Investor" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="pembuat" class="form-control" name="pembuat" placeholder="OPR" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="pengirim" class="form-control" name="pengirim" placeholder="MKT" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="format" class="form-control" name="format" placeholder="Softcopy" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <textarea type="text" id="notes" class="form-control" name="notes" placeholder="jika tidak ada notes silahkan tulis -"></textarea>
                                    </div>
                                </div>
                            </div>
    ...
    <!-- Tambahkan skrip ini di halaman "Tambah Laporan" -->
    <script>
        function updateCountdown() {
            var deadlineInput = new Date(document.getElementById('deadline').value);
            var now = new Date();

            if (deadlineInput < now) {
                document.getElementById('dueDate').textContent = 'Assignment is Overdue';
                return;
            }
            ...
            document.getElementById('dueDate').textContent = days + "d " + hours + "h " + minutes + "m " + seconds + "s";
        }
